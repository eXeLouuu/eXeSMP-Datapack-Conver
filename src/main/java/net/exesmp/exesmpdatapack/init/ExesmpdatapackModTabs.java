...
public class ExesmpdatapackModTabs {
	...
	public static void buildTabContentsVanilla(BuildCreativeModeTabContentsEvent tabData) {
		if (tabData.getTabKey() == CreativeModeTabs.NATURAL_BLOCKS) {
			...
			tabData.accept(ExesmpdatapackModBlocks.MISTRALIT_MADENI.get().asItem());
			tabData.accept(ExesmpdatapackModItems.MISTRALIT_KULCESI.get());
			tabData.accept(ExesmpdatapackModBlocks.VULCANIT_MADENI.get().asItem());
			tabData.accept(ExesmpdatapackModItems.LUMINIT_KULCESI.get());
		} else if (tabData.getTabKey() == CreativeModeTabs.INGREDIENTS) {
			tabData.accept(ExesmpdatapackModItems.ALAZ_PARCASI.get());
			tabData.accept(ExesmpdatapackModItems.ALAZ_KULCESI.get());
			tabData.accept(ExesmpdatapackModItems.AETHRIUM_KULCESI.get());
		}
	}
}
